...
echo "Report on " $currTime > /opt/MegaRAID/perccli/diskInfo.txt
/opt/MegaRAID/perccli/perccli64 /c0 /eall /sall show all >> /opt/MegaRAID/perccli/diskInfo.txt

## Save current to end of history
tail -100000 /opt/MegaRAID/perccli/diskInfoHistory.txt > /opt/MegaRAID/perccli/diskInfoHistory.txt
cat /opt/MegaRAID/perccli/diskInfo.txt >> /opt/MegaRAID/perccli/diskInfoHistory.txt
...
#Make a copy of current disk summary
